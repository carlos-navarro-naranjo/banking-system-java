...
/**
 * Represents a bank for managing costumers and their bank accounts.
 * 
 * @author Carlos Navarro Naranjo
 */
public class Bank {

	public static void main(String[] args) {
		// Inside my main method:
		// I'm going to create an instance of the bank class
		// Type Bank. Call variable bank. new Bank() creates the new instance of the
		// Bank Class
	...
	// In my bank class I'm going create a run method.
	// This will serve to run the program by initializing and running bank accounts
	// & costumers.

	/**
	 * Runs the program by initializing and managing bank accounts and costumers.
	 */

	// Its a public method meaning all other programs inside my project can use this
	// method.
	// returns data type "void" meaning the method is not meant to return anything.
	// run() is the name of the method.
